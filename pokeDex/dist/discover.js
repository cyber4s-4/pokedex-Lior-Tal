...
exports.sortPokemonData = exports.surpriseMe = exports.Pokemon = void 0;
const NUM_OF_POKEMONS = 151;
class Pokemon {
    constructor(name, customData, parentElement) {
        this.name = name;
    ...
    renderPokemon() {
        ...
        let attacks = [];
        let types = [];
        let attacksList = document.createElement("ul");
        ...
        for (const attack of attacks) {
            let singleAttack = document.createElement("div");
            singleAttack.classList.add("attack");
            let attackName = document.createElement("li");
...
function surpriseMe(pokemonArray) {
...
function sortPokemonData(pokemonArray) {
    return pokemonArray.sort((a, b) => {
        return a.name.localeCompare(b.name);
    });
}
exports.sortPokemonData = sortPokemonData;
...
/*!******************************!*\
  !*** ./dist/tsc/discover.js ***!
  \******************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const pokemon_1 = __webpack_require__(/*! ./pokemon */ "./dist/tsc/pokemon.js");
